            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="instructorsTable" class="display table nowrap table-striped table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 270px;">
                                        ...
                                        <a href="{{url('login-by-id/'.$row->id)}}" title="{{__('admin.login_as_instructor')}}" data-bs-toggle="tooltip" data-bs-placement="bottom" class="btn btn-icon btn-primary btn-sm" href="#">
...
new DataTable('#instructorsTable', {
    "createdRow": function(row, data, dataIndex) {
      $('#instructorsTable').removeClass('dataTable');
      $('#instructorsTable').removeClass('datatable');
    },
  language: {
