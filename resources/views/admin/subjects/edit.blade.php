                ...
                <div class="col-md-12">
                  ...
                  <div class="mb-3">
                    ...
                    <select class="select2 form-control" name="terms[]" id="terms" required multiple>
                      ...
                      <option value="1" @if(in_array(1,json_decode($row->terms)))  selected @endif></option>))> {{ __('admin.subjects.term1') }}</option>
                      <option value="2" @if(in_array(2,json_decode($row->terms)))  selected @endif> {{ __('admin.subjects.term2') }}</option>
                      <option value="3" @if(in_array(3,json_decode($row->terms)))  selected @endif> {{ __('admin.subjects.term3') }}</option>
                    </select>
