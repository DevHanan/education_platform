    ...
    <div class="row g-2 align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
          ...
          <a href="{{ url('admin/subjects/create?classroom='.request()->input('classroom')) }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <table  id="subjectTable" class="export-table table card-table table-vcenter text-nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th> {{__('admin.subjects.name')}}</th>
                  <th> {{__('admin.subjects.degree')}}</th>

                  <th>{{ __('admin.subjects.status') }}</th>


                  <th>{{ __('admin.subjects.actions') }}</th>
                </tr>
              </thead>
              <tbody>
                @foreach($rows as $row)
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-check form-switch md-3" style="margin:10px">
                      ...
                      <input data-id="{{$row->id}}" data-type='App\Models\Subject' class="form-check-input form-control toggole-class" type="checkbox" style="float: right;" role="switch" id="flexSwitchCheckDefault" @if($row->active==1) checked="checked" @endif name="active">
                    </div>
                  </td>
