    ...
    <div class="row">
      <div class="col-md-6 p-4">
        ...
        <div class="p-2 d-flex gap-2">
          <input class="form-check-input" type="radio" name="answer" id="ans-1">
        ...
        <div class="p-2 d-flex gap-2">
          <input class="form-check-input" type="radio" name="answer" id="ans-2">
          <h5 class="form-check-label" for="ans-2">
            {{ $question->answer2 }}
          </h5>
        </div>
        <div class="p-2 d-flex gap-2">
          <input class="form-check-input" type="radio" name="answer" id="ans-3">
          <h5 class="form-check-label" for="ans-3">
            {{ $question->answer3 }}
          </h5>
        </div>
        <div class="p-2 d-flex gap-2">
          <input class="form-check-input" type="radio" name="answer" id="ans-4">
