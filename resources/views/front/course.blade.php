                            ...
                            <div class="comment mt-5">
                                <h3 class="primary-color">اضف تعليقك</h2>
                                    <form action="{{url('course-comment')}}" method="POST">
                                        ...
                                        <a   @if(!auth()->guard('students-login')->user() && ($course->isSubscribed == 0  || $course->isSubscribed == -1 )) disabled="disabled" @endif href="{{url($course->google_link_measure_satisfaction)}}" target="_blank" class="btn secondary-bg text-white mt-3" type="submit"> قياس رضا المستفيد <img src="{{ asset('public/front/img/icons/fi-rr-comment-alt.png')}}" width="20" class="mx-3" alt=""></a>
                        ...
                        <div class="shadow-sm border my-4 p-4 py-5 d-flex flex-column align-items-center" style="border-radius: 24px;">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <a target="_blank" href="{{ $course->whatsApp_group_link }}" class="bg-white rounded-circle text-decoration-none mx-2">
                                    <i class="fa-brands fa-whatsapp fa-lg" style="font-size:2em;"></i>
                                </a>
                                @endif
                                ...
                                <a target="_blank" href="{{ $course->telegram_channel_link }}" class="bg-white rounded-circle text-decoration-none mx-2">
                                    <i class="fa-brands fa-telegram fa-lg" style="font-size:2em;"></i>
                                </a>
                                @endif
                            </div>
