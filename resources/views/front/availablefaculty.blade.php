...
<div class="overlay d-none" style="width: 100%;height: 100%;position: absolute;top: 0;left: 0;background-color: rgba(0, 0, 0, 0.418);z-index: 9;"></div>
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="text-center pt-2">
        ...
        <!-- <div class="btn btn-primary" onclick="()">تنسيق {{ date('y')}}</div> -->
            ...
            <div class="shadow-sm p-4 bg-white" style="border-radius:20px ;">
              ...
              <div class="results-page ">
                ...
                <div class="mt-3 border p-3">
                  <div class="row boys">
                    @foreach ($malefaculities as $male)
                    <div class="col-md-10 col-8">
                        <p class="text-secondary text-center border-bottom fw-bold pb-3"> {{$male->name }}</p>
                      </div>
                      <div class="col-md-2 col-4">
                        <div class="btn btn-secondary w-100" style="border-radius:15px ;">{{ $male->min_accept_degree }}</div>
                      </div>
                    @endforeach
                     
                  </div>
                  @foreach ($femalefaculities as $male)
                  <div class="row girls">
                      <div class="col-md-10 col-8">
                        <p class="text-secondary text-center border-bottom fw-bold pb-3">{{ $male->name }} </p>
                      </div>
                      <div class="col-md-2 col-4">
                        <div class="btn btn-primary w-100" style="border-radius:15px ;">{{ $male->min_accept_degree }}</div>
                      </div>
                  </div>
                  @endforeach
